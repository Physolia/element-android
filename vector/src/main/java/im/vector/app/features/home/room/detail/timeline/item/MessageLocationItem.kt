...
abstract class MessageLocationItem : AbsMessageItem<MessageLocationItem.Holder>() {
    ...
    private fun bindLocationLiveBanner(holder: Holder) {
        ...
        // TODO UI adjustments needed for Bubble mode: change constraints of stop button + display timestamp in the banner
        // TODO (https://www.figma.com/file/uthEK6xuo9hSQRdWvPAre5/Location-Sharing?node-id=1488%3A55870)

        // TODO create a dedicated message Item per state: Start, Location, End?
    }
